...
//            Connection conn= DriverManager.getConnection("jdbc:mysql://192.168%/sales_db","and_user","android0216");
...
//            Connection conn= DriverManager.getConnection("jdbc:mysql://192.168.0.32:3306/mybatis?characterEncoding=utf8/sales_db","and_user","android0216");
//            Connection conn= DriverManager.getConnection("jdbc:mysql://192.168.0.32:3306/sales_db/mybatis?characterEncoding=utf8","and_user","android0216");
            Connection conn= DriverManager.getConnection("jdbc:mysql://192.168.0.32:3306/sales_db?characterEncoding=utf8","and_user","android0216");
